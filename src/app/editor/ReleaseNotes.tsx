  ...
  return (
    <AnimatePresence>
      {seenReleaseNotes === currentVersion ? null : (
        ...
        >
          <div
            className="flex w-[min(35rem,80%)] flex-col gap-2 rounded-md border-[4px] border-solid border-primary bg-bgPrimary p-2 md:gap-4 md:p-4"
          ...
          >
            ...
            {versionHistory.map(([version, details]) => (
              <ul
                className="list-outside list-disc rounded-sm bg-bgSecondary p-2 [&>li]:ml-6"
                key={version}
              >
                <p>
